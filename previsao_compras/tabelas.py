...
def criarTabela(frame):
    global table 
    table = ttk.Treeview(frame, columns = ('ID', 'Produto','Linha', 'Classificacao','Estoque', 'Un. Estoque', 'Qtd. Producao', 'Unidade'), show = 'headings', height=25)
    table.heading('ID', text = 'ID')
    table.heading('Produto', text = 'Produto')
    table.heading('Linha', text = 'Linha')
    table.heading('Classificacao', text = 'Classificacao')  # Corrected here
    ...
    table.column('Classificacao', width=160, anchor=CENTER)  # And here
