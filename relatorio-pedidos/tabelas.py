...
def tabelaMotivo(frame):
    ...
    label_pesquisa_sa = Label(frame, text="Pesquisa de produtos Acabados:", font=('Arial', 10, 'bold'))
    label_pesquisa_sa.grid(row=9, column=0, columnspan=2, padx=(80, 0), pady=(10, 0), sticky='nsew')
...
def tabelaMotivoSA(frame):
    ...
    label_semi_acabados.grid(row=13, columnspan=2, padx=(80, 0), pady=(0, 10))
    
    label_pesquisa_sa = Label(frame, text="Pesquisa de produtos Semi-acabado:", font=('Arial', 10, 'bold'))
    label_pesquisa_sa.grid(row=14, column=0, columnspan=2, padx=(80, 0), pady=(10, 0), sticky='nsew')
    ...
    tbl_motivo_semi_acabados.grid(row=16, columnspan=2, padx=(80, 0), pady=10, sticky="nsew")
    ...
    tbl_motivo_semi_acabados.column('Solicitante', width=250, anchor=CENTER)
    tbl_motivo_semi_acabados.column('Motivo', width=250, anchor=CENTER)
    tbl_motivo_semi_acabados.column('Saldo', width=200, anchor=CENTER)
