...
where e.TPDOCTO = 'EC' 
	and e.DTPREVISAO between '20240227' and '20240328'
	and e.SITUACAO = 'Z'
...
#     copiaEvento = evento
#     for a in ajustes:
#         if a['nomeProduto'] == 'Brochetinho de Filet':
#             print(a)
#         if a['idMovtoped'] == evento['idMovtoped']:
#             qtdAjustada = evento['qtdProdutoEvento'] + a['ajuste']
#             return qtdAjustada
#         elif a['idMovtoped'] != evento['idMovtoped']:
#             return evento['qtdProdutoEvento']
...
def somarProdutosEvento():
    ...
    #dfComposicao['qtdProdutoEvento'] = dfComposicao.apply(adicionarAjustes, axis=1)
    ...
    testeJson = dfComposicao.to_json(orient='records')
    testeDesserializado = json.loads(testeJson)
